...
<title>Insert title here</title>
  <style>
    ...
    #updatebtn { 
    	width:130px; height:40px; font-size:1.1em; 
    	font-weight:bold; margin-top:100px; margin-left:220px;
    	text-align: center; 
    }
    ...
    #m_content { 
    	width: 600px; height:auto; text-align:initial;  
    	display: inline-block; margin-left:-160px;
    }
    #selectEmail{width:150px; height:auto; font-size:1.1em;}
      ...
      <div>
        <form id="m_content" action="/mypage/updateUser.do?userId=${loginUser.userId}" method="post">
          ...
          <div>
            ...
            <input type="text" class="r_content" autocomplete="off" spellcheck="false" aria-label="도메인주소" id="userEmail2" name="userEmail2" style="width:100px; margin-left: 4px;" value="${getUser.userEmail2}" required>
